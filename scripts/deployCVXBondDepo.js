...
async function main() {
    ...
    const DOVE = "0x383518188c0c6d7730d91b2c03a03c837814a899";
    ...
    const CVXBond = await ethers.getContractFactory('DoveCVXBondDepository');

    // Deploy CVX bond
    const cvxBond = await CVXBond.deploy(DOVE, CVX, Treasury, DAO);
